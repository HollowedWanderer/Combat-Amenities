...
public record BackSlotCreativeClientPacketPayload(int entityId, int slotId, ItemStack itemStack) implements CustomPayload {
    ...
    public static final Id<BackSlotCreativeClientPacketPayload> BACKSLOT_CREATIVE_CLIENT_PACKET_ID = new Id<>(Identifier.of(CombatAmenities.MOD_ID, "backslot_creative_client_packet"));
