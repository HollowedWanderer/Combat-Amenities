...
public class BackSlotPacket {
    ...
    public static final Identifier BACKSLOT_CLIENT_PACKET_ID = new Identifier(MOD_ID, "backslot_client_packet");

    public static final Identifier BACKSLOT_PACKET_ID = new Identifier(MOD_ID, "backslot_packet");

    public static void register() {
        ServerPlayNetworking.registerGlobalReceiver(BACKSLOT_PACKET_ID, (server, player, handler, buf, responseSender) -> server.execute(() -> {
